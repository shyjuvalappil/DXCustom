...
import StyledBrtExtensionsOneTimePasscodeWrapper from './styles';
...
function BrtExtensionsOneTimePasscode(props: BrtExtensionsOneTimePasscodeProps) {
 const {
    getPConnect,
    placeholder,
    validatemessage,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledBrtExtensionsOneTimePasscodeWrapper> {displayComp} </StyledBrtExtensionsOneTimePasscodeWrapper>
    ) : (
      <StyledBrtExtensionsOneTimePasscodeWrapper>
      <FieldValueList
...
export default withConfiguration(BrtExtensionsOneTimePasscode);
